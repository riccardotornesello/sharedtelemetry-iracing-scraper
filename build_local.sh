...
docker build -t "europe-west1-docker.pkg.dev/sharedtelemetryapp/sessions-downloader/qualify-results:latest" --file docker/Dockerfile.qualify-results .
...
docker push "europe-west1-docker.pkg.dev/sharedtelemetryapp/sessions-downloader/qualify-results:latest"
